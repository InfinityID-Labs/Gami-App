...
export const canisterId = process.env.CANISTER_ID_TOKEN_LEDGER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_ledger.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_ledger canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_ledger.did.js")._SERVICE>}
 */
export const token_ledger = createActor(canisterId);
