...
import { idlFactory } from './quest_rewards.did.js';
export { idlFactory } from './quest_rewards.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_QUEST_REWARDS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./quest_rewards.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the quest_rewards canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./quest_rewards.did.js")._SERVICE>}
 */
export const quest_rewards = createActor(canisterId);
