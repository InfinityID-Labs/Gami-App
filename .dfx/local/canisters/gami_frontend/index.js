...
import { idlFactory } from './gami_frontend.did.js';
export { idlFactory } from './gami_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_GAMI_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./gami_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the gami_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./gami_frontend.did.js")._SERVICE>}
 */
export const gami_frontend = createActor(canisterId);
