...
export const canisterId = process.env.CANISTER_ID_LEADERBOARD;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./leaderboard.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the leaderboard canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./leaderboard.did.js")._SERVICE>}
 */
export const leaderboard = createActor(canisterId);
